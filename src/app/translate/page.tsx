...
export default function TranslatePage() {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4 space-y-4 sm:space-y-5 pb-8 md:pb-4">
      {/* Breadcrumb Bar */}
      <BreadcrumbNav items={[{ label: "Dịch Văn Bản", icon: "🌐" }]} />
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-sm sm:text-base font-extrabold text-gray-900 tracking-tight truncate">Dịch Văn Bản AI</h1>
              <p className="text-[11px] text-gray-500 truncate hidden sm:block">
                Dịch tự động đa ngôn ngữ sử dụng LibreTranslate AI & Gemini
              </p>
            </div>
          </div>
        </div>
