...
export default function GrammarPage() {
  const { collections, isLoading, addCollection, updateCollection, deleteCollection, exportAllCollections } = useGrammarCollections();
  ...
  const handleSubmitCollection = useCallback(async () => {
    ...
    if (editingCollectionId) {
      updateCollection(editingCollectionId, {
        ...
        description: collectionFormDescription || undefined,
      });
    } else {
      addCollection(collectionFormName, collectionFormDescription || undefined);
    }

    resetCollectionForm();
  }, [collectionFormName, collectionFormDescription, editingCollectionId, addCollection, updateCollection, resetCollectionForm]);

  const handleStartEditCollection = useCallback((id: string) => {
        ...
        {!showAddForm ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">
              {editingCollectionId ? 'Chỉnh sửa bộ ngữ pháp' : 'Tạo bộ ngữ pháp mới'}
            </h2>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && handleSubmitCollection()}
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setCollectionFormDescription(e.target.value)}
              ...
              <div className="flex gap-3">
                ...
                >
                  {editingCollectionId ? 'Lưu thay đổi' : 'Tạo'}
                </button>
                <button
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-2 flex-wrap">
                  <button
                    onClick={() => handleStartEditCollection(collection.id)}
                    className="px-4 py-2 bg-amber-50 text-amber-700 rounded-lg hover:bg-amber-100 transition font-medium text-sm"
                  >
                    📝 Sửa bộ
                  </button>
                  <Link
