      ...
      <div className={`rounded-xl sm:rounded-2xl px-3.5 py-2.5 sm:px-5 sm:py-3 shadow-2xs border transition-all duration-300 bg-gradient-to-r ${
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2.5">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-gray-500 truncate hidden sm:block">
                Học từ vựng Flashcard SRS, Cấu trúc ngữ pháp & Tra cứu từ điển thông minh
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 flex-wrap">
            <Link
              href="/exam"
              className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg sm:rounded-xl shadow-xs transition-all text-xs flex items-center gap-1 active:scale-98"
            >
              <span>📝</span> Luyện Thi JLPT
            </Link>
            <Link
              href="/curriculum"
              className="px-3 py-1.5 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-lg sm:rounded-xl border border-gray-200 shadow-3xs transition-colors text-xs"
            >
              📚 Lộ trình
            </Link>
            <Link
